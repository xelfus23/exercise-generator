...
const RenderItemHeight = React.memo(({ value, index, selectedItem, itemWidth }) => {
    return (
        <View
            style={{
                alignItems: "center",
...
const RenderItemWeight = React.memo(({ value, index, selectedItem, itemWidth }) => {
    return (
        <View
            style={{
                alignItems: "center",
...
const HeightAndWeight = React.memo(({ setSelectedHeightAndWeight, selectedHeightAndWeight, next, heightOptions, weightOptions }) => {
